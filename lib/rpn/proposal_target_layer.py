...
class ProposalTargetLayer(nn.Module):
    ...
    def forward(self, input_dict):
        ...
        batch_gt_of_rois_src = batch_gt_of_rois.clone().detach()
        ...
        heading_label = batch_gt_of_rois[:, :, 6] % (2 * np.pi)  # 0 ~ 2pi
        ...
        batch_gt_of_rois[:,:,6]=heading_label
        ...
        output_dict = { 'sampled_pts'   : sampled_pts.view(-1, cfg.RCNN.NUM_POINTS, 3),
                        ...
                        'gt_of_rois_src': batch_gt_of_rois_src.view(-1,7)
                        }
